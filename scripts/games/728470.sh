#!/bin/bash
# Game-profile hook for Astroneer Dedicated Server (App ID: 728470)
#
# Astroneer has no native Linux binary. It runs under Wine (64-bit).
# GAME_LAUNCH_CMD is auto-set to:
#   xvfb-run --auto-servernum --server-args='-screen 0 640x480x24:32' wine64 ./AstroServer.exe
#
...
export GAME_LAUNCH_CMD="${GAME_LAUNCH_CMD:-xvfb-run --auto-servernum --server-args='-screen 0 640x480x24:32' wine64 ./AstroServer.exe}"
