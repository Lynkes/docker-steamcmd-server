#!/bin/bash
# Game-profile hook for Sons of The Forest Dedicated Server (App ID: 1326470)
#
# Sons of The Forest has no native Linux binary. It runs under Wine (64-bit).
# GAME_LAUNCH_CMD is auto-set to:
#   xvfb-run --auto-servernum --server-args='-screen 0 640x480x24:32' wine64 ./SonsOfTheForestDS.exe
#
...
export GAME_LAUNCH_CMD="${GAME_LAUNCH_CMD:-xvfb-run --auto-servernum --server-args='-screen 0 640x480x24:32' wine64 ./SonsOfTheForestDS.exe}"
